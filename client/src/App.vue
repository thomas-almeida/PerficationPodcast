...
<template>
  <nav>
    <section>
      <input type="text" placeholder="Pesquise Podcasts, Episódios e Artistas" v-model="inputValue" @keyup.enter="podFetch">
    ...
    <div class="content" v-if="searchData">
      <ul>
        <li v-for="episode in searchData.episodes.items" :key="episode.data">
          <img :src="episode.data.coverArt.sources[1].url" :alt="episode.data.name" draggable="false">
          <section>
